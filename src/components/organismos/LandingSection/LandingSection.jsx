      ...
      <section>
        <div className={styles.Container_Image}>
             <picture className={styles.container_Title}>
                <img className={styles.imgUno} src='src/components/atoms/img/Logo.png' alt="Bulbasor Img" />
            </picture>

            <picture className={styles.container_picture}>
                <img className={styles.imgDos} src='src/components/atoms/img/bulbasorLanding.png' alt="Pokemon tittle" />
            </picture> 
        </div>
